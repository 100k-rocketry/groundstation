/*
 ...
 ---------------------Commercial License--------------------
 Commercial use of CanvasJS requires you to purchase a license. Without a commercial license you can use it for evaluation purposes for upto 30 days. Please refer to the following link for further details.
     http://canvasjs.com/
...
f="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),g=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,h=/[^-+\dA-Z]/g;return function(l,k,n){var m=n?n.days:d,p=n?n.months:c,e=n?n.shortDays:b,r=n?n.shortMonths:f;n="";var q=!1;l=l&&l.getTime?l:l?new Date(l):new Date;if(isNaN(l))throw SyntaxError("invalid date");"UTC:"===k.slice(0,4)&&(k=k.slice(4),q=!0);n=q?"getUTC":"get";var s=l[n+"Date"](),v=l[n+"Day"](),
w=l[n+"Month"](),y=l[n+"FullYear"](),t=l[n+"Hours"](),u=l[n+"Minutes"](),$=l[n+"Seconds"](),ba=l[n+"Milliseconds"](),x=q?0:l.getTimezoneOffset();return n=k.replace(a,function(a){switch(a){case "D":return s;case "DD":return O(s,2);case "DDD":return e[v];case "DDDD":return m[v];case "M":return w+1;case "MM":return O(w+1,2);case "MMM":return r[w];case "MMMM":return p[w];case "Y":return parseInt(String(y).slice(-2));case "YY":return O(String(y).slice(-2),2);case "YYY":return O(String(y).slice(-3),3);
case "YYYY":return O(y,4);case "h":return t%12||12;case "hh":return O(t%12||12,2);case "H":return t;case "HH":return O(t,2);case "m":return u;case "mm":return O(u,2);case "s":return $;case "ss":return O($,2);case "f":return String(ba).slice(0,1);case "ff":return O(String(ba).slice(0,2),2);case "fff":return O(String(ba).slice(0,3),3);case "t":return 12>t?"a":"p";case "tt":return 12>t?"am":"pm";case "T":return 12>t?"A":"P";case "TT":return 12>t?"AM":"PM";case "K":return q?"UTC":(String(l).match(g)||
[""]).pop().replace(h,"");case "z":return(0<x?"-":"+")+Math.floor(Math.abs(x)/60);case "zz":return(0<x?"-":"+")+O(Math.floor(Math.abs(x)/60),2);case "zzz":return(0<x?"-":"+")+O(Math.floor(Math.abs(x)/60),2)+O(Math.abs(x)%60,2);default:return a.slice(1,a.length-1)}})}}(),da=function(a,d,b){if(null===a)return"";a=Number(a);var c=0>a?!0:!1;c&&(a*=-1);var f=b?b.decimalSeparator:".",g=b?b.digitGroupSeparator:",",h="";d=String(d);var h=1,l=b="",k=-1,n=[],m=[],p=0,e=0,r=0,q=!1,s=0,l=d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
d=null;for(var v=0;l&&v<l.length;v++)if(d=l[v],"."===d&&0>k)k=v;else{if("%"===d)h*=100;else if("\u2030"===d){h*=1E3;continue}else if(","===d[0]&&"."===d[d.length-1]){h/=Math.pow(1E3,d.length-1);k=v+d.length-1;continue}else"E"!==d[0]&&"e"!==d[0]||"0"!==d[d.length-1]||(q=!0);0>k?(n.push(d),"#"===d||"0"===d?p++:","===d&&r++):(m.push(d),"#"!==d&&"0"!==d||e++)}q&&(d=Math.floor(a),l=-Math.floor(Math.log(a)/Math.LN10+1),s=0===a?0:0===d?-(p+l):String(d).length-p,h/=Math.pow(10,s));0>k&&(k=v);h=(a*h).toFixed(e);
...
(b=g+b)):b=1<d.length&&('"'===d[0]&&'"'===d[d.length-1]||"'"===d[0]&&"'"===d[d.length-1])?d.slice(1,d.length-1)+b:d+b:(d=0>s?d.replace("+","").replace("-",""):d.replace("-",""),b+=d.replace(/[0]+/,function(a){return O(s,a.length)}));g="";for(n=!1;0<m.length;)d=m.shift(),"#"===d||"0"===d?0<a.length&&0!==Number(a.join(""))?(g+=a.shift(),n=!0):"0"===d&&(g+="0",n=!0):1<d.length&&('"'===d[0]&&'"'===d[d.length-1]||"'"===d[0]&&"'"===d[d.length-1])?g+=d.slice(1,d.length-1):"E"!==d[0]&&"e"!==d[0]||"0"!==d[d.length-
1]||!/[eE][+-]*[0]+/.test(d)?g+=d:(d=0>s?d.replace("+","").replace("-",""):d.replace("-",""),g+=d.replace(/[0]+/,function(a){return O(s,a.length)}));b+=(n?f:"")+g;return c?"-"+b:b},za=function(a){var d=0,b=0;a=a||window.event;a.offsetX||0===a.offsetX?(d=a.offsetX,b=a.offsetY):a.layerX||0==a.layerX?(d=a.layerX,b=a.layerY):(d=a.pageX-a.target.offsetLeft,b=a.pageY-a.target.offsetTop);return{x:d,y:b}},Na=!0,Ba=window.devicePixelRatio||1,ua=1,R=Na?Ba/ua:1,Ua=window&&window.location&&window.location.href&&
