...
\begin{document}
	...
	\index{Raw files}
	The simplest persistence method is to save the raw data stream to a file as it comes in.
	This method would be very low cost, in terms of development time and processing and memory impact.
	The data would simply be read from the serial port and saved to a file, where it could be reconstructed at a later time.
	Saving the data at this point, before any processing is done will 
	\subsection{JSON}
	\index{JSON}	
	\subsection{???}
