...
\begin{document}
	...
	\subsection{Retrieval Options}
	 For retrieval of data and tracking of the rocket we have decided to use either C, C++, or Python as our choices for 
	 the languages.  
	 We chose these languages because they can all be used for data collecting.
