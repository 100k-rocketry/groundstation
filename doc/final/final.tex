...
% The following \lstdefinedlanguage and \lstset are copyright
% commonhare (https://tex.stackexchange.com/users/24016/commonhare)
...
\hfill
\begin{figure}[h]
	\includegraphics[width=\linewidth]{ganttchartfinal.eps}
...
I used several resources from the universities repeatedly. One of those happens to be a Computer Science Professor, Mike Bailey. He helped me understand if what I wanted to create was possible, how to break it up into steps, and then gave guidance when I was struggling with the visualization. 

The threejs.org website also helped me pull inspiration for the project and gave me a sense of what was possible. That being said, I also used lecture slides from the Computer Shaders, Computer Graphics, and from Computer Animation classes to get a sense of how people percieve visuals on a screen versus in real life. Online WebGL tutorials were also very useful. Plenty can be found on YouTube.
% Use subsubsubsections here, not subsubsections.
% The really long section names look weird in the table of contents.
% Also don't end the subsubsubsection name with punctuation or else you will
% get something like: "My section title?:"
% Keep an empty line between each subsubsubsection for best results
...
WebGL and OpenGL. OpenGL I was learning through classes as well but WebGL was outside the scope of what was covered. Node.js was also another big one. 

\subsubsubsection{What non-technical information did you learn}
The virtual 3D world can be extremely disorientating if there is no reference for up and down, left or right. Also, writing long documents can be frustrating at times but rewarding when they can be used for any hiccups that happen further down the road.

\subsubsubsection{What have you learned about project work}
Project work takes dedication, commitment, and patience.

\subsubsubsection{What have you learned about project management}
Managing any group of people can be hard, especially if each person's work is interdependent upon anothers. We had some issues with backend work and frontend work causing conflicts but after the Al brought up the idea of separating them out into different branches, we could get work done. 

\subsubsubsection{What have you learned about working in teams}
Working in a team with roughly thirty people and all from various backgrounds means that there are a lot of resources to pull from but that does not mean that everyone understands were the other is coming from. It also requires compromise. Meeting regularly helps keep everyone on the same page and allows for others to ask help if they are struggling. Even when a specific portion of the project is going up in flames, figuratively or literally, we had to keep in mind that support was important.

\subsubsubsection{If you could do it all over, what would you do differently}
I would definitely make sure to work with the ECE team more from the very beginning and keep it that way throughout the entire project. We had offered them help early on. Unfortunately, I do not think they realized how much they could benefit from our skill sets when it came to coding as well as testing until we were near the end of the project.
