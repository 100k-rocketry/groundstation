...
\begin{document}
	...
	\author {
		Individual Progress Report: Anisimova, Natasha 
		\and
		Lee, Terrance
		\and
		Morgan, Albert
...
It is spring term and we have a design and a good framework for the entire system.
...
We have begun on the details of the system, such as implementing the specific telemetry packet protocol and making the user interface look like its final form. It feels like it is close to being done.

\section{Team Overview}
\subsection{Natasha Anisimova}
I am the visualization person of our team. Everything that the High-Altitude Rocketry team gets to see, is what I display to them based off of the information that I receive from the protocol. The code for handling the communication protocol between the receiver that the ECE team has and the client was mainly written by Albert and Terrance. If problems or errors occurred, I would do what I could to help debug it. Often times, I am the one that does the presentation slides for our weekly meetings with our client and starts off the presentation but everyone chips in. There have been some problems with the graphics card on my personal computer and well as family emergencies. Due to this, I am often suggesting to go work in the Computer Graphics Lab located in BAT Hall.

\subsection{Terrance Lee}
Terrance works with Al mainly. We do have our weekly team meetings with just our group of three, the Teaching Assistant, and the all of the High-Altitude Rocketry Team. During that time we all work together. Now that we are in the six month of our development and working as a team, I believe that Terrance and I have contributed an equal amount to the project.

\subsection{Albert Morgan}
Al is definitely our team lead. He was the one that suggested we separate out our branches so that I was able to continue my visualization work even if the communication protocol breaks. Every week we then merge our branches and handle any merge conflicts in that three to five hour block of time on Mondays. Albert came up with this idea and so far it has worked well, I only wish we had this idea early on. Looking back on the last six months, I believe Albert has contributed the most out of all of us to the Groundstation Software.
...
\hline
The ECE team is close to being finished so we will be able to integrate our software with their hardware soon.
...
Specifically, a commit that broke one part of the code prevented another team member from doing their work. A serious setback for me was being gone on dead week for an international conference. It left me scrambling to finish up with all of my classes. Since everyone has been going through finals, I have not had a chance to meet up with the rest of the team to go over changes that have been made in explicit detail but I do have an overview.
...
\end{itemize}
\section{Development Log: Rest of Winter 2017}
\subsection{Week 6}
\subsubsection{Anisimova, Natasha}
\begin{itemize}
	\item \textbf{Plans: }
