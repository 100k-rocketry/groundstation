...
<<<<<<< HEAD
		put diagram of camera controls here + citation for it:
		%\begin{figure}
		%	\includegraphics[width=\linewidth]{cameracontrols.eps}
		%	\caption{A diagram of the camera view controls.}
		%	\label{fig:1}
		%\end{figure}
=======
		put diagram of camera controls here:
>>>>>>> 36ea92529e650dfb7d6fd083f8cd35a02e46ce45
		
		Figure \ref{fig:1} Shows camera view controls.
		...
		put diagram of earth's atmosphere:
	%			\begin{figure}
	%		\includegraphics[width=\linewidth]{earth-atmosphere-layers.jpg}
	...
	\begin{figure}
	\includegraphics[width=5cm]{cameracontrols.eps}
	\caption{A diagram of the camera view controls.}
	\label{fig:1}
	\end{figure}
