...
\}
	...
	{The user can interact with the view by using a mouse or track pad.}
	{
		...
		Figure \ref{fig:1} Shows camera view controls that will be located in the top right corner of the browser.
	}
	\begin{figure}
	...
	\begin{figure}
		\includegraphics[width=\linewidth]{earth-atmosphere-layers.eps}
		\caption{A diagram of the Earth's atmosphere.}
		\label{fig:2}
	\end{figure}
